...
insert  into `customers`(`CusID`,`CusNick`,`CusLogin`,`CusPwd`,`CusPoint`,`CusCreateDate`,`CusLoginDate`) values (1,'黑暗之女','123','123',2250,'2016-04-29 22:08:13','2016-11-21 22:09:27'),(2,'寒冰射手','123','123',7366,'2015-12-23 22:08:13','2016-09-05 22:09:27'),(3,'牛头酋长','123','123',9277,'2016-06-26 22:08:13','2016-08-28 22:09:27'),(4,'卡牌大师','123','123',3809,'2016-03-25 22:08:13','2016-08-16 22:09:27'),(5,'战争女神','123','123',613,'2016-03-09 22:08:13','2016-10-24 22:09:27'),(6,'迅捷斥候','123','123',1039,'2016-06-07 22:08:13','2016-09-29 22:09:27'),(7,'审判天使','123','123',2754,'2016-06-05 22:08:13','2016-09-01 22:09:27'),(8,'末日使者','123','123',10052,'2016-03-27 22:08:13','2016-10-06 22:09:27'),(9,'雪人骑士','123','123',1400,'2016-08-22 22:08:13','2016-08-22 22:09:27'),(10,'流浪法师','123','123',6245,'2016-06-29 22:08:13','2016-11-06 22:09:27'),(11,'小寜','qwer','qwer',700,'2022-02-15 17:20:46',NULL),(12,'张三','qwer','qwer',790,'2022-02-15 17:44:30',NULL);
...
/* Function  structure for function  `fn_GetAssess` */

/*!50003 DROP FUNCTION IF EXISTS `fn_GetAssess` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fn_GetAssess`(ncusid int) RETURNS varchar(5000) CHARSET utf8
begin 
...
/* Function  structure for function  `fn_ning` */

/*!50003 DROP FUNCTION IF EXISTS `fn_ning` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fn_ning`(number int,money decimal) RETURNS decimal(10,0)
return number*money */$$
DELIMITER ;

/* Function  structure for function  `fn_setpoint` */

/*!50003 DROP FUNCTION IF EXISTS `fn_setpoint` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fn_setpoint`(ncusid int) RETURNS int(11)
begin 
...
/* Function  structure for function  `fn_test5` */

/*!50003 DROP FUNCTION IF EXISTS `fn_test5` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fn_test5`(n INT) RETURNS int(11)
BEGIN
	DECLARE nsum INT DEFAULT 0;-- 累加和
...
/* Function  structure for function  `fn_whileTest2` */

/*!50003 DROP FUNCTION IF EXISTS `fn_whileTest2` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fn_whileTest2`(A INT,B int) RETURNS int(11)
BEGIN 
	DECLARE i INT DEFAULT 0;
...
/* Function  structure for function  `fn_whileTest3` */

/*!50003 DROP FUNCTION IF EXISTS `fn_whileTest3` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fn_whileTest3`(A int) RETURNS int(11)
BEGIN 
...
/* Function  structure for function  `fn_whileTest4` */

/*!50003 DROP FUNCTION IF EXISTS `fn_whileTest4` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fn_whileTest4`(pid INT,pnumber INT,ptype int) RETURNS int(11)
BEGIN 
...
/* Function  structure for function  `fn_whilethst1` */

/*!50003 DROP FUNCTION IF EXISTS `fn_whilethst1` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fn_whilethst1`(number int) RETURNS int(11)
begin 
	declare i int default 0;
	declare sums int default 0;		
...
/* Function  structure for function  `fn_whilethstl` */

/*!50003 DROP FUNCTION IF EXISTS `fn_whilethstl` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fn_whilethstl`(number int) RETURNS int(11)
begin 
	declare i int default 0;
	declare sums int default 0;
